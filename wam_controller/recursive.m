...
Mt(:,:,7)= M(:,:,7);
Mt(:,:,6)= M(:,:,6) + transpose(B(7,6))*Mt(:,:,7)*B(7,6);
Mt(:,:,5)= M(:,:,5) + transpose(B(6,5))*Mt(:,:,6)*B(6,5);
Mt(:,:,4)= M(:,:,4) + transpose(B(5,4))*Mt(:,:,5)*B(5,4);
Mt(:,:,3)= M(:,:,3) + transpose(B(4,3))*Mt(:,:,4)*B(4,3);
Mt(:,:,2)= M(:,:,2) + transpose(B(3,2))*Mt(:,:,3)*B(3,2);
Mt(:,:,1)= M(:,:,1) + transpose(B(2,1))*Mt(:,:,2)*B(2,1);
