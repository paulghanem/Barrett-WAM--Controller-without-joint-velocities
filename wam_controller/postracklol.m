...
t_d = 0:Ts:2;
yd= [-0.11060+0.5*(exp(0.5*t_d))-0.5;
-1.932+0.5*(exp(0.5*t_d))-0.5;
-0.192+0*ones(1,length(t_d));
3.1+ 1-exp(0.5*t_d)];
...
yd=[-0.11060;-1.932;-0.19200;3.1;0.2825;0.0969;-0.2798]*ones(1,n);
