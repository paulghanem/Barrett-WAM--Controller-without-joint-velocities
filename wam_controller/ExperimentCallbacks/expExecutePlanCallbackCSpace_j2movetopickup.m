    ...
    switch(experiment.state)
        ...
        case 2
            ...
            if(sum(callbackData.wamDataRcvd.qdes == arm_ready) == 7)
                ...
                setWSGSetForcePeriod(callbackData.netInfo,10);
                fprintf('State %d\n',experiment.state);
            end
        ...
        case 6
            ...
            if(callbackData.recvTime - experiment.stateTime >= 5)
                ...
                sendArmCspaceMove(callbackData.netInfo,experiment.firstWaypoint);
                experiment.state = experiment.state + 1;
                experiment.stateTime = callbackData.recvTime;
                fprintf('State 7\n');
            end
        ...
        case 8
            ...
            if(sum(callbackData.wamDataRcvd.qdes == arm_ready) == 7)
                ...
                experiment.state = experiment.state + 1;
                experiment.stateTime = callbackData.recvTime;
                setWSGSetForcePeriod(callbackData.netInfo,-1);
                getWSGForce(callbackData.netInfo);
                fprintf('State 9\n');
            end
        case 9
