function [experiment,callbackData] = expCylinderGraspMove( experiment, callbackData )
...
%   Detailed explanation goes here
    ...
    switch(experiment.state)
        ...
        case 7
            ...
            % Travel for 1 second before closing the hand
        ...
        case 8
            fprintf('State 8\n');
            % Give enough time to grab the cylinder, then move cylinder to over the tape square
            if(callbackData.recvTime - experiment.stateTime >= 3)
               sendArmJspaceMove(callbackData.netInfo, invKin2DOF(.65,.14));
               experiment.stateTime = callbackData.recvTime;
               experiment.state = experiment.state+1;
            end
