...
%             experiment.state = experiment.state+1;
        case 3
            ...
            sendArmJspaceMove(callbackData.netInfo, qstart, qd, qdd);
        ...
        case 5
            ...
            if(callbackData.recvTime - experiment.stateTime >= 2)
                experiment.record = 1;
                sendArmJspaceMove(callbackData.netInfo, qend, qd, qddg);
                experiment.stateTime = callbackData.recvTime;
                experiment.state = experiment.state+1;
            end
...
%             experiment.state = 0;
        ...
        case 8
            ...
            if(sum(callbackData.wamDataRcvd.qdes == [-2.1885 -pi/2 pi/2 1.8530]) == 4 && ...
        ...
        case 9
            ...
            if(callbackData.recvTime - experiment.stateTime >= 0.5)
                sendArmJspaceMove(callbackData.netInfo, qstart, qd, qdd);
                experiment.stateTime = callbackData.recvTime;
                experiment.state = experiment.state+1;
            end
        ...
        case 11
            ...
            if(callbackData.recvTime - experiment.stateTime >= 0.1)
                sendHandOpen(callbackData.netInfo);
                experiment.stateTime = callbackData.recvTime;
                experiment.state = experiment.state+1;
            end
        ...
        case 13
            % wait for arm to get to qstart
            if(sum(callbackData.wamDataRcvd.qdes == qstart) == 4 && ...
                    callbackData.recvTime - experiment.stateTime >= 3)
        ...
        case 14
            % wait for arm to get to 0 position
